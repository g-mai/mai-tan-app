...
function RouteComponent() {
  return (
    <TechStackPage
      ...
      role="Every schema, migration, and query in src/lib/db runs through Drizzle against PostgreSQL, including the auto-generated Better Auth schema in auth-schema.ts."
